...
public class KMeansReducer implements FirstClassJavaTask {
	...
	public void invoke() throws Exception {
		...
		oldClustersIn.close();
// Brett
//printFinalOutput(oldClusters);
printFinalClusters(result);
//
...
// Brett
	public void printFinalOutput(double[][] oldClusters) throws Exception {
		File file = new File("/tmp/data/output" + iteration + ".txt");
		if (!file.exists()) {
			file.createNewFile();
		}
...
// Brett
	public void printFinalClusters(KMeansMapperResult result) throws Exception {
		File file = new File("/tmp/data/clusterCentroid" + iteration + ".txt");
		if (!file.exists()) {
			file.createNewFile();
		}
		FileWriter fw = new FileWriter(file.getAbsoluteFile());
